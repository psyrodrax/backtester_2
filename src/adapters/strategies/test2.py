...
class Test(EventBusAdapter, Strategy):
    ...
    def on_order_changed(self, event: events.OrderFilled):
        ...
        # print(f"Remaining cash: {self.broker.available_cash}")
